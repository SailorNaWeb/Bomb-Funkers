...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("bomberfunkers", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("bomberfunkers", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "bomberfunkers";
		app.meta["name"] = "Bomber Funkers";
