...
#define INCLUDED_objects_AttachedAchievement
...
class HXCPP_CLASS_ATTRIBUTES AttachedAchievement_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		enum { _hx_ClassId = 0x66b7f9f7 };

		void __construct(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::String name);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="objects.AttachedAchievement")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"objects.AttachedAchievement"); }
...
#endif /* INCLUDED_objects_AttachedAchievement */ 
