...
HX_DECLARE_STACK_FRAME(_hx_pos_40e6927fd11a022a_28_new)
...
HXLINE(  31)		( ( ::backend::WeekData)(__this) )->folder = HX_("",00,00,00,00);
HXLINE(  69)		( ( ::backend::WeekData)(__this) )->songs = ( (::cpp::VirtualArray)(weekFile->__Field(HX_("songs",fe,36,c7,80),::hx::paccDynamic)) );
HXLINE(  70)		( ( ::backend::WeekData)(__this) )->weekCharacters = ( (::Array< ::String >)(weekFile->__Field(HX_("weekCharacters",be,b5,7f,1d),::hx::paccDynamic)) );
HXLINE(  71)		( ( ::backend::WeekData)(__this) )->weekBackground = ( (::String)(weekFile->__Field(HX_("weekBackground",02,f1,ce,ed),::hx::paccDynamic)) );
HXLINE(  72)		( ( ::backend::WeekData)(__this) )->weekBefore = ( (::String)(weekFile->__Field(HX_("weekBefore",93,97,02,5d),::hx::paccDynamic)) );
HXLINE(  73)		( ( ::backend::WeekData)(__this) )->storyName = ( (::String)(weekFile->__Field(HX_("storyName",e0,50,20,29),::hx::paccDynamic)) );
HXLINE(  74)		( ( ::backend::WeekData)(__this) )->weekName = ( (::String)(weekFile->__Field(HX_("weekName",5f,08,2f,30),::hx::paccDynamic)) );
HXLINE(  75)		( ( ::backend::WeekData)(__this) )->freeplayColor = ( (::Array< int >)(weekFile->__Field(HX_("freeplayColor",a3,0c,53,32),::hx::paccDynamic)) );
HXLINE(  76)		( ( ::backend::WeekData)(__this) )->startUnlocked = ( (bool)(weekFile->__Field(HX_("startUnlocked",a5,96,c9,60),::hx::paccDynamic)) );
HXLINE(  77)		( ( ::backend::WeekData)(__this) )->hiddenUntilUnlocked = ( (bool)(weekFile->__Field(HX_("hiddenUntilUnlocked",17,ed,31,dc),::hx::paccDynamic)) );
HXLINE(  78)		( ( ::backend::WeekData)(__this) )->hideStoryMode = ( (bool)(weekFile->__Field(HX_("hideStoryMode",d6,b4,4e,4c),::hx::paccDynamic)) );
HXLINE(  79)		( ( ::backend::WeekData)(__this) )->hideFreeplay = ( (bool)(weekFile->__Field(HX_("hideFreeplay",82,13,8c,e3),::hx::paccDynamic)) );
HXLINE(  80)		( ( ::backend::WeekData)(__this) )->difficulties = ( (::String)(weekFile->__Field(HX_("difficulties",59,c7,5e,02),::hx::paccDynamic)) );
HXLINE(  82)		( ( ::backend::WeekData)(__this) )->fileName = fileName;
            	}
