...
#define INCLUDED_backend_Section

#ifndef HXCPP_H
#include <hxcpp.h>
#endif

HX_DECLARE_CLASS1(backend,Section)
...
class HXCPP_CLASS_ATTRIBUTES Section_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x529ca731 };

		void __construct(::hx::Null< Float >  __o_sectionBeats);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="backend.Section")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"backend.Section"); }
...
#endif /* INCLUDED_backend_Section */ 
