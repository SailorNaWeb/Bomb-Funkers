...
class HXCPP_CLASS_ATTRIBUTES Paths_obj : public ::hx::Object
{
	...
	public:
		...
		static ::String getPath(::String file,::String type,::String library, ::Dynamic modsAllowed);
		static ::Dynamic getPath_dyn();

		static ::String getLibraryPath(::String file,::String library);
		static ::Dynamic getLibraryPath_dyn();

		static ::String getLibraryPathForce(::String file,::String library,::String level);
		...
		static  ::flixel::graphics::FlxGraphic image(::String key,::String library, ::Dynamic allowGPU);
		...
		static  ::flixel::graphics::frames::FlxAtlasFrames getAtlas(::String key,::String library);
		static ::Dynamic getAtlas_dyn();

		static  ::flixel::graphics::frames::FlxAtlasFrames getSparrowAtlas(::String key,::String library, ::Dynamic allowGPU);
		static ::Dynamic getSparrowAtlas_dyn();

		static  ::flixel::graphics::frames::FlxAtlasFrames getPackerAtlas(::String key,::String library, ::Dynamic allowGPU);
