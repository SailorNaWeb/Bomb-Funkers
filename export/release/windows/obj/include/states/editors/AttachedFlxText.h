...
#define INCLUDED_states_editors_AttachedFlxText
...
HX_DECLARE_CLASS2(states,editors,AttachedFlxText)
...
class HXCPP_CLASS_ATTRIBUTES AttachedFlxText_obj : public  ::flixel::text::FlxText_obj
{
	...
	public:
		...
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="states.editors.AttachedFlxText")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"states.editors.AttachedFlxText"); }
...
#endif /* INCLUDED_states_editors_AttachedFlxText */ 
