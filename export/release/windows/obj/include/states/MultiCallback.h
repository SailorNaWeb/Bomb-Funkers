...
#define INCLUDED_states_MultiCallback
...
class HXCPP_CLASS_ATTRIBUTES MultiCallback_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x27aaa8d8 };

		void __construct( ::Dynamic callback,::String logId);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="states.MultiCallback")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"states.MultiCallback"); }
...
#endif /* INCLUDED_states_MultiCallback */ 
