...
class HXCPP_CLASS_ATTRIBUTES Option_obj : public ::hx::Object
{
	...
	public:
		...
		void __construct(::String name,::String __o_description,::String variable,::String __o_type,::Array< ::String > options);
		...
		static ::hx::ObjectPtr< Option_obj > __new(::String name,::String __o_description,::String variable,::String __o_type,::Array< ::String > options);
		static ::hx::ObjectPtr< Option_obj > __alloc(::hx::Ctx *_hx_ctx,::String name,::String __o_description,::String variable,::String __o_type,::Array< ::String > options);
