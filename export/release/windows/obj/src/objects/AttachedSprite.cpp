...
HXLINE(  19)			 ::flixel::graphics::FlxGraphic imageLoaded = ::backend::Paths_obj::image(file,null(),true);
...
HXDLIN(  19)			if (::hx::IsNotNull( imageLoaded )) {
HXLINE(  19)				_hx_tmp = imageLoaded;
            			}
            			else {
HXLINE(  19)				_hx_tmp = ::backend::Paths_obj::image(file,library,true);
            			}
HXDLIN(  19)			 ::Dynamic _hx_tmp1;
HXDLIN(  19)			if (xmlExists) {
HXLINE(  19)				_hx_tmp1 = ::sys::io::File_obj::getContent(xml);
            			}
            			else {
HXLINE(  19)				_hx_tmp1 = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + file) + HX_(".xml",69,3e,c3,1e)),null(),library,null());
            			}
HXDLIN(  19)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,_hx_tmp1));
