...
HXDLIN(  13)		 ::flixel::graphics::FlxGraphic imageLoaded = ::backend::Paths_obj::image(HX_("checkboxanim",d4,35,91,c5),null(),true);
...
HXLINE(  13)			_hx_tmp = ::backend::Paths_obj::image(HX_("checkboxanim",d4,35,91,c5),library,true);
            		}
HXDLIN(  13)		 ::Dynamic _hx_tmp1;
HXDLIN(  13)		if (xmlExists) {
HXLINE(  13)			_hx_tmp1 = ::sys::io::File_obj::getContent(xml);
            		}
            		else {
HXLINE(  13)			_hx_tmp1 = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("checkboxanim",d4,35,91,c5)) + HX_(".xml",69,3e,c3,1e)),null(),library,null());
            		}
...
HXLINE(  44)				_hx_tmp = (this->animation->_curAnim->name != HX_("unchecking",73,08,bf,32));
            			}
            			else {
...
HXLINE(  46)				{
HXLINE(  46)					 ::flixel::math::FlxBasePoint this1 = this->offset;
HXDLIN(  46)					this1->set_x(( (Float)(25) ));
HXDLIN(  46)					this1->set_y(( (Float)(28) ));
            				}
            			}
            		}
...
HXLINE(  61)			{
HXLINE(  61)				 ::flixel::math::FlxBasePoint this1 = this->offset;
HXDLIN(  61)				this1->set_x(( (Float)(0) ));
HXDLIN(  61)				this1->set_y(( (Float)(2) ));
            			}
