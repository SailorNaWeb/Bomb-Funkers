...
HXDLIN(  60)					{
HXLINE(  60)						int _g = 0;
HXDLIN(  60)						::Array< ::String > _g1 = ::Reflect_obj::fields(val);
HXDLIN(  60)						while((_g < _g1->length)){
HXLINE(  60)							::String n = _g1->__get(_g);
HXDLIN(  60)							_g = (_g + 1);
...
HXDLIN(  58)						{
HXLINE(  58)							 ::Dynamic n = res->iterator();
HXDLIN(  58)							while(( (bool)(n->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  58)								 ::Dynamic n1 = n->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
...
HXDLIN(  58)								 ::Dynamic _g1_value = ::haxe::IMap_obj::get(_g_map,key);
HXDLIN(  58)								::String _g1_key = key;
HXDLIN(  58)								::String index = _g1_key;
HXDLIN(  58)								 ::Dynamic val = _g1_value;
HXDLIN(  58)								{
HXLINE(  58)									lua_pushstring(l,::Std_obj::string(index));
HXDLIN(  58)									::llua::Convert_obj::toLua(l,val);
...
HXLINE(  62)							 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN(  62)							::String _hx_tmp1;
HXDLIN(  62)							if (::hx::IsNull( val )) {
HXLINE(  62)								_hx_tmp1 = HX_("null",87,9e,0e,49);
            							}
            							else {
HXLINE(  62)								_hx_tmp1 = ::Std_obj::string(val);
            							}
HXDLIN(  62)							::String _hx_tmp2 = ((((HX_("Haxe value of ",a0,a2,a0,58) + _hx_tmp1) + HX_(" of type ",7d,e8,d0,a2)) + ::Std_obj::string(::Type_obj::_hx_typeof(val))) + HX_(" not supported!",40,ec,72,be));
HXDLIN(  62)							_hx_tmp(_hx_tmp2,::hx::SourceInfo(HX_("llua/Convert.hx",6e,6a,e3,49),62,HX_("llua.Convert",31,b8,44,19),HX_("toLua",fd,0a,14,14)));
            						}
...
HXLINE(  90)				return 1;
            			...
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic _g = _hx_e;
HXLINE(  92)				 ::haxe::Exception e = ::haxe::Exception_obj::caught(_g);
...
HXLINE(  94)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            			}
            			else {
...
HXDLIN( 117)				 ::Dynamic _g1_value = ::haxe::IMap_obj::get(_g_map,key);
HXDLIN( 117)				::String _g1_key = key;
HXDLIN( 117)				::String index = _g1_key;
HXDLIN( 117)				 ::Dynamic val = _g1_value;
HXDLIN( 117)				{
...
HXLINE( 237)								_hx_tmp = (::Std_obj::_hx_int(index) != index);
            							}
            							else {
...
HXLINE( 244)			return  ::Dynamic(::hx::Anon_obj::Create(0));
            		}
            		else {
HXLINE( 246)			if (array) {
...
HXLINE( 248)						{
HXLINE( 249)							int index = (::Std_obj::_hx_int(lua_tonumber(l,-2)) - 1);
HXLINE( 250)							v->set(index,::llua::Convert_obj::fromLua(l,-1));
            						}
HXLINE(  12)						lua_pop(l,1);
            					}
            					_hx_goto_18:;
