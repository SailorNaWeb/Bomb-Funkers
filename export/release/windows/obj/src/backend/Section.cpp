...
HX_DEFINE_STACK_FRAME(_hx_pos_18ba045eced201fc_15_new,"backend.Section","new",0x5210d1dd,"backend.Section.new","backend/Section.hx",15,0xc98f4374)
HX_LOCAL_STACK_FRAME(_hx_pos_18ba045eced201fc_27_boot,"backend.Section","boot",0x74bfd015,"backend.Section.boot","backend/Section.hx",27,0xc98f4374)
namespace backend{

void Section_obj::__construct(::hx::Null< Float >  __o_sectionBeats){
            		Float sectionBeats = __o_sectionBeats.Default(4);
            	HX_STACKFRAME(&_hx_pos_18ba045eced201fc_15_new)
...
HXLINE(  32)		::haxe::Log_obj::trace((HX_("test created section: ",45,80,aa,78) + sectionBeats),::hx::SourceInfo(HX_("source/backend/Section.hx",68,1f,ab,10),32,HX_("backend.Section",6b,9f,b9,90),HX_("new",60,d0,53,00)));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_18ba045eced201fc_27_boot)
HXDLIN(  27)		COPYCAT = 0;
            	}
}
