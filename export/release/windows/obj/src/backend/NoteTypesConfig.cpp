...
HXLINE(  20)		::String str = ::backend::Paths_obj::getTextFromFile(((HX_("custom_notetypes/",16,04,18,a1) + name) + HX_(".txt",02,3f,c0,1e)),null());
...
HXLINE(  35)				{
HXLINE(  35)					int _g = 0;
HXDLIN(  35)					int _g1 = arr->length;
HXDLIN(  35)					while((_g < _g1)){
HXLINE(  35)						_g = (_g + 1);
HXDLIN(  35)						int i = (_g - 1);
HXDLIN(  35)						arr[i] = ::StringTools_obj::trim(arr->__get(i));
            					}
            				}
...
HXLINE(  75)					{
HXLINE(  75)						int _g = 0;
HXDLIN(  75)						int _g1 = (split->length - 1);
