...
HXLINE(  76)		{
HXLINE(  76)			::String v3 = (::ManifestResources_obj::rootPath + HX_("manifest/week_assets.json",88,97,37,e3));
HXDLIN(  76)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week_assets",ae,a0,93,a0),v3);
            		}
HXLINE(  77)		{
HXLINE(  77)			::String v4 = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  77)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v4);
            		}
HXLINE(  60)		 ::lime::utils::AssetLibrary library = ::lime::utils::Assets_obj::getLibrary(HX_("videos",98,d7,95,e5));
HXLINE(  81)		if (::hx::IsNotNull( library )) {
HXLINE(  81)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  82)			::ManifestResources_obj::preloadLibraryNames->push(HX_("videos",98,d7,95,e5));
            		}
HXLINE(  83)		library = ::lime::utils::Assets_obj::getLibrary(HX_("songs",fe,36,c7,80));
...
HXLINE(  89)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week_assets",ae,a0,93,a0));
HXLINE(  90)		if (::hx::IsNotNull( library )) {
HXLINE(  90)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  91)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week_assets",ae,a0,93,a0));
            		}
HXLINE(  92)		library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
