...
HX_LOCAL_STACK_FRAME(_hx_pos_9d9f724dcba0f141_57_details,"haxe.Exception","details",0x13a1b73b,"haxe.Exception.details","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Exception.hx",57,0xc2abb812)
HX_LOCAL_STACK_FRAME(_hx_pos_9d9f724dcba0f141_63___shiftStack,"haxe.Exception","__shiftStack",0x45445d6d,"haxe.Exception.__shiftStack","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Exception.hx",63,0xc2abb812)
...
HX_LOCAL_STACK_FRAME(_hx_pos_9d9f724dcba0f141_71_get_previous,"haxe.Exception","get_previous",0x5217ff27,"haxe.Exception.get_previous","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Exception.hx",71,0xc2abb812)
...
HX_LOCAL_STACK_FRAME(_hx_pos_9d9f724dcba0f141_79_get_stack,"haxe.Exception","get_stack",0xfc45ee58,"haxe.Exception.get_stack","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Exception.hx",79,0xc2abb812)
...
::String Exception_obj::details(){
            	HX_STACKFRAME(&_hx_pos_9d9f724dcba0f141_57_details)
HXDLIN(  57)		if (::hx::IsNull( this->get_previous() )) {
HXDLIN(  57)			::String _hx_tmp = (HX_("Exception: ",95,cc,ac,54) + this->toString());
...
void Exception_obj::_hx___shiftStack(){
            	HX_STACKFRAME(&_hx_pos_9d9f724dcba0f141_63___shiftStack)
...
HX_DEFINE_DYNAMIC_FUNC0(Exception_obj,get_message,return )
 ...
 ::haxe::Exception Exception_obj::get_previous(){
            	HX_STACKFRAME(&_hx_pos_9d9f724dcba0f141_71_get_previous)
...
::Array< ::Dynamic> Exception_obj::get_stack(){
            	HX_STACKFRAME(&_hx_pos_9d9f724dcba0f141_79_get_stack)
