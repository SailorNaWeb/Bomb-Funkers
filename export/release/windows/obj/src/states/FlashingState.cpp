...
HX_DEFINE_STACK_FRAME(_hx_pos_3121e6e564aa22cb_9_new,"states.FlashingState","new",0x540715a5,"states.FlashingState.new","states/FlashingState.hx",9,0xc151f76c)
HX_LOCAL_STACK_FRAME(_hx_pos_3121e6e564aa22cb_15_create,"states.FlashingState","create",0x0390fad7,"states.FlashingState.create","states/FlashingState.hx",15,0xc151f76c)
HX_LOCAL_STACK_FRAME(_hx_pos_3121e6e564aa22cb_34_update,"states.FlashingState","update",0x0e8719e4,"states.FlashingState.update","states/FlashingState.hx",34,0xc151f76c)
HX_LOCAL_STACK_FRAME(_hx_pos_3121e6e564aa22cb_47_update,"states.FlashingState","update",0x0e8719e4,"states.FlashingState.update","states/FlashingState.hx",47,0xc151f76c)
HX_LOCAL_STACK_FRAME(_hx_pos_3121e6e564aa22cb_46_update,"states.FlashingState","update",0x0e8719e4,"states.FlashingState.update","states/FlashingState.hx",46,0xc151f76c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_3121e6e564aa22cb_11_boot,"states.FlashingState","boot",0x2a44db4d,"states.FlashingState.boot","states/FlashingState.hx",11,0xc151f76c)
namespace states{
...
void FlashingState_obj::__construct( ::flixel::addons::transition::TransitionData TransIn, ::flixel::addons::transition::TransitionData TransOut){
            	HX_STACKFRAME(&_hx_pos_3121e6e564aa22cb_9_new)
...
void FlashingState_obj::create(){
            	HX_GC_STACKFRAME(&_hx_pos_3121e6e564aa22cb_15_create)
...
HXLINE(  21)		this->warnText =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,0,0,::flixel::FlxG_obj::width,HX_("Hey, watch out!\n\n\t\t\tThis Mod contains some flashing lights!\n\n\t\t\tPress ENTER to disable them now or go to Options Menu.\n\n\t\t\tPress ESCAPE to ignore this message.\n\n\t\t\tYou've been warned!",99,b4,d1,af),32,null());
HXLINE(  28)		this->warnText->setFormat(HX_("VCR OSD Mono",be,44,e4,b8),32,-1,HX_("center",d5,25,db,05),null(),null(),null());
HXLINE(  29)		{
HXLINE(  29)			 ::flixel::text::FlxText _this = this->warnText;
HXDLIN(  29)			int axes = 16;
...
HXLINE(  30)		this->add(this->warnText);
            	}


void FlashingState_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_3121e6e564aa22cb_34_update)
HXLINE(  35)		if (!(::states::FlashingState_obj::leftState)) {
HXLINE(  36)			bool back = this->get_controls()->get_BACK();
HXLINE(  37)			bool _hx_tmp;
HXDLIN(  37)			if (!(this->get_controls()->get_ACCEPT())) {
HXLINE(  37)				_hx_tmp = back;
            			}
            			else {
HXLINE(  37)				_hx_tmp = true;
            			}
HXDLIN(  37)			if (_hx_tmp) {
HXLINE(  38)				::states::FlashingState_obj::leftState = true;
HXLINE(  39)				::flixel::addons::transition::FlxTransitionableState_obj::skipNextTransIn = true;
HXLINE(  40)				::flixel::addons::transition::FlxTransitionableState_obj::skipNextTransOut = true;
HXLINE(  41)				if (!(back)) {
            					HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            					void _hx_run( ::flixel::effects::FlxFlicker flk){
            						HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            						void _hx_run( ::flixel::util::FlxTimer tmr){
            							HX_GC_STACKFRAME(&_hx_pos_3121e6e564aa22cb_47_update)
HXLINE(  47)							::backend::MusicBeatState_obj::switchState( ::states::TitleState_obj::__alloc( HX_CTX ,null(),null()));
            						}
            						HX_END_LOCAL_FUNC1((void))

            						HX_GC_STACKFRAME(&_hx_pos_3121e6e564aa22cb_46_update)
HXLINE(  46)						 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(((Float)0.5), ::Dynamic(new _hx_Closure_0()),null());
            					}
            					HX_END_LOCAL_FUNC1((void))

HXLINE(  42)					::backend::ClientPrefs_obj::data->flashing = false;
HXLINE(  43)					::backend::ClientPrefs_obj::saveSettings();
...
HXLINE(  45)					::flixel::effects::FlxFlicker_obj::flicker(this->warnText,1,((Float)0.1),false,true, ::Dynamic(new _hx_Closure_1()),null());
            				}
            				else {
            					HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_2) HXARGC(1)
            					void _hx_run( ::flixel::tweens::FlxTween twn){
            						HX_GC_STACKFRAME(&_hx_pos_3121e6e564aa22cb_54_update)
HXLINE(  54)						::backend::MusicBeatState_obj::switchState( ::states::TitleState_obj::__alloc( HX_CTX ,null(),null()));
            					}
            					HX_END_LOCAL_FUNC1((void))

HXLINE(  51)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN(  51)					_hx_tmp->play(::backend::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),null(),null(),null(),null(),null());
HXLINE(  52)					::flixel::tweens::FlxTween_obj::tween(this->warnText, ::Dynamic(::hx::Anon_obj::Create(1)
...
{
{
            	HX_STACKFRAME(&_hx_pos_3121e6e564aa22cb_11_boot)
HXDLIN(  11)		leftState = false;
            	}
}
