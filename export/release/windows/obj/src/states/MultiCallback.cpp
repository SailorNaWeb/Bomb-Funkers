...
HX_DEFINE_STACK_FRAME(_hx_pos_a49218e3c891c30f_264_new,"states.MultiCallback","new",0x08bd2704,"states.MultiCallback.new","states/LoadingState.hx",264,0x41b125bc)
HX_LOCAL_STACK_FRAME(_hx_pos_a49218e3c891c30f_288_add,"states.MultiCallback","add",0x08b348c5,"states.MultiCallback.add","states/LoadingState.hx",288,0x41b125bc)
HX_LOCAL_STACK_FRAME(_hx_pos_a49218e3c891c30f_281_add,"states.MultiCallback","add",0x08b348c5,"states.MultiCallback.add","states/LoadingState.hx",281,0x41b125bc)
HX_LOCAL_STACK_FRAME(_hx_pos_a49218e3c891c30f_313_log,"states.MultiCallback","log",0x08bbab28,"states.MultiCallback.log","states/LoadingState.hx",313,0x41b125bc)
HX_LOCAL_STACK_FRAME(_hx_pos_a49218e3c891c30f_317_getFired,"states.MultiCallback","getFired",0x7efa9254,"states.MultiCallback.getFired","states/LoadingState.hx",317,0x41b125bc)
HX_LOCAL_STACK_FRAME(_hx_pos_a49218e3c891c30f_318_getUnfired,"states.MultiCallback","getUnfired",0xa9ee6edb,"states.MultiCallback.getUnfired","states/LoadingState.hx",318,0x41b125bc)
namespace states{

void MultiCallback_obj::__construct( ::Dynamic callback,::String logId){
            	HX_GC_STACKFRAME(&_hx_pos_a49218e3c891c30f_264_new)
HXLINE( 272)		this->fired = ::Array_obj< ::String >::__new();
HXLINE( 271)		this->unfired =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 269)		this->numRemaining = 0;
HXLINE( 268)		this->length = 0;
HXLINE( 267)		this->logId = null();
HXLINE( 276)		this->callback = callback;
HXLINE( 277)		this->logId = logId;
            	}
...
bool MultiCallback_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic MultiCallback_obj::add(::String __o_id){
            		...
            		void _hx_run(){
            			HX_STACKFRAME(&_hx_pos_a49218e3c891c30f_288_add)
HXLINE( 288)			if (_gthis->unfired->exists(id1->__get(0))) {
HXLINE( 290)				_gthis->unfired->remove(id1->__get(0));
HXLINE( 291)				_gthis->fired->push(id1->__get(0));
HXLINE( 292)				_gthis->numRemaining--;
HXLINE( 294)				if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 295)					if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 295)						::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + ((((HX_("fired ",72,04,21,89) + id1->__get(0)) + HX_(", ",74,26,00,00)) + _gthis->numRemaining) + HX_(" remaining",d6,c2,10,c5))),::hx::SourceInfo(HX_("source/states/LoadingState.hx",b0,0b,1c,f1),314,HX_("states.MultiCallback",12,95,5c,7a),HX_("log",84,54,52,00)));
            					}
            				}
HXLINE( 297)				if ((_gthis->numRemaining == 0)) {
HXLINE( 299)					if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 300)						if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 300)							::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + HX_("all callbacks fired",5d,d8,ec,82)),::hx::SourceInfo(HX_("source/states/LoadingState.hx",b0,0b,1c,f1),314,HX_("states.MultiCallback",12,95,5c,7a),HX_("log",84,54,52,00)));
            						}
            					}
HXLINE( 301)					_gthis->callback();
            				}
            			}
            			else {
HXLINE( 305)				if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 305)					::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + (HX_("already fired ",fa,e7,0c,57) + id1->__get(0))),::hx::SourceInfo(HX_("source/states/LoadingState.hx",b0,0b,1c,f1),314,HX_("states.MultiCallback",12,95,5c,7a),HX_("log",84,54,52,00)));
            				}
            			}
            		}
            	...
            	HX_STACKFRAME(&_hx_pos_a49218e3c891c30f_281_add)
HXDLIN( 281)		::Array< ::String > id1 = ::Array_obj< ::String >::__new(1)->init(0,id);
HXDLIN( 281)		 ::states::MultiCallback _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 282)		id1[0] = (((HX_("",00,00,00,00) + this->length) + HX_(":",3a,00,00,00)) + id1->__get(0));
HXLINE( 283)		this->length++;
HXLINE( 284)		this->numRemaining++;
HXLINE( 285)		 ::Dynamic func = null();
HXLINE( 286)		func =  ::Dynamic(new _hx_Closure_0(id1,_gthis));
HXLINE( 307)		this->unfired->set(id1->__get(0),func);
HXLINE( 308)		return func;
            	}
...
void MultiCallback_obj::log(::String msg){
            	HX_STACKFRAME(&_hx_pos_a49218e3c891c30f_313_log)
HXDLIN( 313)		if (::hx::IsNotNull( this->logId )) {
HXLINE( 314)			::haxe::Log_obj::trace((((HX_("",00,00,00,00) + this->logId) + HX_(": ",a6,32,00,00)) + msg),::hx::SourceInfo(HX_("source/states/LoadingState.hx",b0,0b,1c,f1),314,HX_("states.MultiCallback",12,95,5c,7a),HX_("log",84,54,52,00)));
            		}
            	}
...
::Array< ::String > MultiCallback_obj::getFired(){
            	HX_STACKFRAME(&_hx_pos_a49218e3c891c30f_317_getFired)
HXDLIN( 317)		return this->fired->copy();
            	}
...
::Array< ::String > MultiCallback_obj::getUnfired(){
            	HX_STACKFRAME(&_hx_pos_a49218e3c891c30f_318_getUnfired)
HXDLIN( 318)		::Array< ::String > _g = ::Array_obj< ::String >::__new(0);
HXDLIN( 318)		{
HXDLIN( 318)			 ::Dynamic id = this->unfired->keys();
HXDLIN( 318)			while(( (bool)(id->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN( 318)				::String id1 = ( (::String)(id->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXDLIN( 318)				_g->push(id1);
            			}
            		}
HXDLIN( 318)		return _g;
            	}
