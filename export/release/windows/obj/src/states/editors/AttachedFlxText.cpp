...
HX_DEFINE_STACK_FRAME(_hx_pos_81e9e9a8d436fb44_3212_new,"states.editors.AttachedFlxText","new",0xd2160e19,"states.editors.AttachedFlxText.new","states/editors/ChartingState.hx",3212,0x0f29a547)
HX_LOCAL_STACK_FRAME(_hx_pos_81e9e9a8d436fb44_3223_update,"states.editors.AttachedFlxText","update",0x86cfe1f0,"states.editors.AttachedFlxText.update","states/editors/ChartingState.hx",3223,0x0f29a547)
namespace states{
namespace editors{
...
void AttachedFlxText_obj::__construct(::hx::Null< Float >  __o_X,::hx::Null< Float >  __o_Y,::hx::Null< Float >  __o_FieldWidth,::String Text,::hx::Null< int >  __o_Size,::hx::Null< bool >  __o_EmbeddedFont){
            	...
            	HX_STACKFRAME(&_hx_pos_81e9e9a8d436fb44_3212_new)
HXLINE(3216)		this->yAdd = ((Float)0);
HXLINE(3215)		this->xAdd = ((Float)0);
HXLINE(3219)		super::__construct(X,Y,FieldWidth,Text,Size,EmbeddedFont);
            	}
...
bool AttachedFlxText_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x752f90b6) {
		if (inClassId<=(int)0x2c01639b) {
			if (inClassId<=(int)0x2974b4e3) {
				return inClassId==(int)0x00000001 || inClassId==(int)0x2974b4e3;
			} else {
...
void AttachedFlxText_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_81e9e9a8d436fb44_3223_update)
HXLINE(3224)		this->super::update(elapsed);
HXLINE(3226)		if (::hx::IsNotNull( this->sprTracker )) {
HXLINE(3227)			this->setPosition((this->sprTracker->x + this->xAdd),(this->sprTracker->y + this->yAdd));
HXLINE(3228)			this->set_angle(this->sprTracker->angle);
HXLINE(3229)			this->set_alpha(this->sprTracker->alpha);
            		}
            	}
...
::hx::ObjectPtr< AttachedFlxText_obj > AttachedFlxText_obj::__alloc(::hx::Ctx *_hx_ctx,::hx::Null< Float >  __o_X,::hx::Null< Float >  __o_Y,::hx::Null< Float >  __o_FieldWidth,::String Text,::hx::Null< int >  __o_Size,::hx::Null< bool >  __o_EmbeddedFont) {
	AttachedFlxText_obj *__this = (AttachedFlxText_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(AttachedFlxText_obj), true, "states.editors.AttachedFlxText"));
...
void AttachedFlxText_obj::__register()
{
	...
	__mClass->mName = HX_("states.editors.AttachedFlxText",a7,0d,65,3f);
