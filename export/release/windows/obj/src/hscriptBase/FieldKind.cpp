...
::hscriptBase::FieldKind FieldKind_obj::KFunction( ::Dynamic f)
{
	return ::hx::CreateEnum< FieldKind_obj >(HX_("KFunction",83,2a,be,ba),0,1)->_hx_init(0,f);
}

::hscriptBase::FieldKind FieldKind_obj::KVar( ::Dynamic v)
{
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("hscriptBase.FieldKind",44,dc,68,bb), ::hx::TCanCast< FieldKind_obj >,FieldKind_obj_sStaticFields,0,
