...
::hscriptBase::_Interp::Stop Stop_obj::SBreak;

::hscriptBase::_Interp::Stop Stop_obj::SContinue;

::hscriptBase::_Interp::Stop Stop_obj::SReturn;
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("hscriptBase._Interp.Stop",67,a7,76,0e), ::hx::TCanCast< Stop_obj >,Stop_obj_sStaticFields,0,
