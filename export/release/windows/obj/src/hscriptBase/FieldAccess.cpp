...
::hscriptBase::FieldAccess FieldAccess_obj::AInline;

::hscriptBase::FieldAccess FieldAccess_obj::AMacro;

::hscriptBase::FieldAccess FieldAccess_obj::AOverride;

::hscriptBase::FieldAccess FieldAccess_obj::APrivate;

::hscriptBase::FieldAccess FieldAccess_obj::APublic;

::hscriptBase::FieldAccess FieldAccess_obj::AStatic;
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("hscriptBase.FieldAccess",94,2c,4e,91), ::hx::TCanCast< FieldAccess_obj >,FieldAccess_obj_sStaticFields,0,
