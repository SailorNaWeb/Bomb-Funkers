...
::hscriptBase::ModuleDecl ModuleDecl_obj::DClass( ::Dynamic c)
{
	return ::hx::CreateEnum< ModuleDecl_obj >(HX_("DClass",54,71,ca,0b),2,1)->_hx_init(0,c);
}

::hscriptBase::ModuleDecl ModuleDecl_obj::DImport(::Array< ::String > path, ::Dynamic everything,::String asIdent)
{
	return ::hx::CreateEnum< ModuleDecl_obj >(HX_("DImport",c9,a0,ca,48),1,3)->_hx_init(0,path)->_hx_init(1,everything)->_hx_init(2,asIdent);
}

::hscriptBase::ModuleDecl ModuleDecl_obj::DPackage(::Array< ::String > path)
{
	return ::hx::CreateEnum< ModuleDecl_obj >(HX_("DPackage",a2,a3,68,40),0,1)->_hx_init(0,path);
}

::hscriptBase::ModuleDecl ModuleDecl_obj::DTypedef( ::Dynamic c)
{
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("hscriptBase.ModuleDecl",60,95,e2,c3), ::hx::TCanCast< ModuleDecl_obj >,ModuleDecl_obj_sStaticFields,0,
