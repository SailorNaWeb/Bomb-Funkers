...
::hscriptBase::Token Token_obj::TBkClose;

::hscriptBase::Token Token_obj::TBkOpen;

::hscriptBase::Token Token_obj::TBrClose;

::hscriptBase::Token Token_obj::TBrOpen;

::hscriptBase::Token Token_obj::TComma;

::hscriptBase::Token Token_obj::TConst( ::hscriptBase::Const c)
{
	return ::hx::CreateEnum< Token_obj >(HX_("TConst",6f,b8,85,73),1,1)->_hx_init(0,c);
}

::hscriptBase::Token Token_obj::TDot;

::hscriptBase::Token Token_obj::TDoubleDot;

::hscriptBase::Token Token_obj::TEof;

::hscriptBase::Token Token_obj::TEol;

::hscriptBase::Token Token_obj::TId(::String s)
{
	return ::hx::CreateEnum< Token_obj >(HX_("TId",4f,fd,3f,00),2,1)->_hx_init(0,s);
}

::hscriptBase::Token Token_obj::TMeta(::String s)
{
	return ::hx::CreateEnum< Token_obj >(HX_("TMeta",39,31,db,90),16,1)->_hx_init(0,s);
}

::hscriptBase::Token Token_obj::TOp(::String s)
{
	return ::hx::CreateEnum< Token_obj >(HX_("TOp",95,02,40,00),3,1)->_hx_init(0,s);
}

::hscriptBase::Token Token_obj::TPClose;

::hscriptBase::Token Token_obj::TPOpen;

::hscriptBase::Token Token_obj::TPrepro(::String s)
{
	return ::hx::CreateEnum< Token_obj >(HX_("TPrepro",5e,e3,5d,88),17,1)->_hx_init(0,s);
}

::hscriptBase::Token Token_obj::TQuestion;

::hscriptBase::Token Token_obj::TStatement;
...
bool Token_obj::__GetStatic(const ::String &inName, ::Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("TEol",ce,a8,ba,37)) { outValue = Token_obj::TEol; return true; }
	...
	if (inName==HX_("TStatement",3b,cd,69,fa)) { outValue = Token_obj::TStatement; return true; }
...
int Token_obj::__FindIndex(::String inName)
{
	...
	if (inName==HX_("TEol",ce,a8,ba,37)) return 11;
	...
	if (inName==HX_("TStatement",3b,cd,69,fa)) return 10;
...
int Token_obj::__FindArgCount(::String inName)
{
	...
	if (inName==HX_("TEof",c8,a8,ba,37)) return 0;
	if (inName==HX_("TEol",ce,a8,ba,37)) return 0;
	...
	if (inName==HX_("TStatement",3b,cd,69,fa)) return 0;
...
::hx::Val Token_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("TEol",ce,a8,ba,37)) return TEol;
	...
	if (inName==HX_("TStatement",3b,cd,69,fa)) return TStatement;
...
static ::String Token_obj_sStaticFields[] = {
	...
	HX_("TStatement",3b,cd,69,fa),
	HX_("TEol",ce,a8,ba,37),
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("hscriptBase.Token",0f,15,ba,66), ::hx::TCanCast< Token_obj >,Token_obj_sStaticFields,0,
...
TEol = ::hx::CreateConstEnum< Token_obj >(HX_("TEol",ce,a8,ba,37),11);
...
TStatement = ::hx::CreateConstEnum< Token_obj >(HX_("TStatement",3b,cd,69,fa),10);
}
