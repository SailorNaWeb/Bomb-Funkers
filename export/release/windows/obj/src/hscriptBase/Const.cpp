...
::hscriptBase::Const Const_obj::CFloat(Float f)
{
	return ::hx::CreateEnum< Const_obj >(HX_("CFloat",59,62,ad,5f),1,1)->_hx_init(0,f);
}

::hscriptBase::Const Const_obj::CInt(int v)
{
	return ::hx::CreateEnum< Const_obj >(HX_("CInt",6c,10,81,2c),0,1)->_hx_init(0,v);
}

::hscriptBase::Const Const_obj::CString(::String s, ::Dynamic interpolated)
{
	return ::hx::CreateEnum< Const_obj >(HX_("CString",74,b1,e2,27),2,2)->_hx_init(0,s)->_hx_init(1,interpolated);
}
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("hscriptBase.Const",79,8b,ec,9c), ::hx::TCanCast< Const_obj >,Const_obj_sStaticFields,0,
