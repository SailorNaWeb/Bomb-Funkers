...
HXLINE(  98)			 ::flixel::FlxState nextState1 = nextState;
HXDLIN(  98)			 ::flixel::FlxState stateOnCall = ::flixel::FlxG_obj::game->_state;
HXDLIN(  98)			 ::Dynamic _hx_tmp = ::Reflect_obj::field(::flixel::FlxG_obj::game->_state,HX_("switchTo",8f,f8,d6,0d));
HXDLIN(  98)			if (( (bool)(_hx_tmp(nextState1)) )) {
...
HXLINE(  98)						::flixel::FlxG_obj::game->_requestedState = nextState1;
            					}
            				}
            				HX_END_LOCAL_FUNC0((void))

HXLINE(  98)				::flixel::FlxG_obj::game->_state->startOutro( ::Dynamic(new _hx_Closure_0(nextState1,stateOnCall)));
            			}
            		}
            		HX_END_LOCAL_FUNC0((void))
...
HXLINE(  96)		this->transitionOut( ::Dynamic(new _hx_Closure_1(nextState)));
