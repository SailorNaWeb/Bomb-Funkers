...
HX_DEFINE_STACK_FRAME(_hx_pos_015f8e5857f13f23_571_new,"flixel.addons.ui.FlxUIDropDownHeader","new",0x97950645,"flixel.addons.ui.FlxUIDropDownHeader.new","flixel/addons/ui/FlxUIDropDownMenu.hx",571,0x238549da)
static const int _hx_array_data_73217fd3_1[] = {
	(int)1,(int)1,(int)14,(int)14,
};
HX_LOCAL_STACK_FRAME(_hx_pos_015f8e5857f13f23_614_destroy,"flixel.addons.ui.FlxUIDropDownHeader","destroy",0x07c8b95f,"flixel.addons.ui.FlxUIDropDownHeader.destroy","flixel/addons/ui/FlxUIDropDownMenu.hx",614,0x238549da)
namespace flixel{
namespace addons{
namespace ui{
...
void FlxUIDropDownHeader_obj::__construct(::hx::Null< int >  __o_Width, ::flixel::FlxSprite Background, ::flixel::addons::ui::FlxUIText Text, ::flixel::addons::ui::FlxUISpriteButton Button){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_015f8e5857f13f23_571_new)
HXLINE( 572)		super::__construct(null(),null());
HXLINE( 574)		this->background = Background;
HXLINE( 575)		this->text = Text;
HXLINE( 576)		this->button = Button;
HXLINE( 579)		if (::hx::IsNull( this->background )) {
HXLINE( 581)			this->background =  ::flixel::addons::ui::FlxUI9SliceSprite_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),HX_("flixel/flixel-ui/img/box.png",dd,a4,cf,5b), ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,0,0,Width,20),::Array_obj< int >::fromData( _hx_array_data_73217fd3_1,4),null(),null(),null(),null(),null(),null(),null(),null());
            		}
HXLINE( 585)		if (::hx::IsNull( this->button )) {
HXLINE( 587)			this->button =  ::flixel::addons::ui::FlxUISpriteButton_obj::__alloc( HX_CTX ,0,0, ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,0,HX_("flixel/flixel-ui/img/dropdown_mark.png",cd,eb,34,3e)),null());
HXLINE( 588)			 ::flixel::addons::ui::FlxUISpriteButton _hx_tmp = this->button;
HXDLIN( 588)			_hx_tmp->loadGraphicSlice9(::cpp::VirtualArray_obj::__new(1)->init(0,HX_("flixel/flixel-ui/img/button_thin.png",58,62,55,9f)),80,20,::Array_obj< ::Dynamic>::__new(1)->init(0,::flixel::util::FlxStringUtil_obj::toIntArray(HX_("6,6,11,11",c0,1f,fa,07))),0,-1,false,18,18,null());
            		}
HXLINE( 591)		 ::flixel::addons::ui::FlxUISpriteButton _hx_tmp = this->button;
HXDLIN( 591)		Float _hx_tmp1 = this->background->get_height();
HXDLIN( 591)		_hx_tmp->resize(_hx_tmp1,this->background->get_height());
HXLINE( 592)		 ::flixel::addons::ui::FlxUISpriteButton _hx_tmp2 = this->button;
HXDLIN( 592)		Float _hx_tmp3 = this->background->x;
HXDLIN( 592)		Float _hx_tmp4 = (_hx_tmp3 + this->background->get_width());
HXDLIN( 592)		_hx_tmp2->set_x((_hx_tmp4 - this->button->get_width()));
HXLINE( 595)		this->button->set_width(( (Float)(Width) ));
HXLINE( 596)		 ::flixel::addons::ui::FlxUISpriteButton fh = this->button;
HXDLIN( 596)		fh->offset->set_x((fh->offset->x - ( (Float)((Width - this->button->frameWidth)) )));
HXLINE( 597)		this->button->set_x(this->offset->x);
HXLINE( 598)		 ::flixel::FlxSprite fh1 = ( ( ::flixel::FlxSprite)(this->button->label) );
HXDLIN( 598)		fh1->offset->set_x((fh1->offset->x + this->button->offset->x));
HXLINE( 601)		if (::hx::IsNull( this->text )) {
HXLINE( 603)			this->text =  ::flixel::addons::ui::FlxUIText_obj::__alloc( HX_CTX ,0,0,::Std_obj::_hx_int(this->background->get_width()),null(),null(),null());
            		}
HXLINE( 605)		this->text->setPosition(2,4);
HXLINE( 606)		this->text->set_color(-16777216);
HXLINE( 608)		this->add(this->background);
HXLINE( 609)		this->add(this->button);
HXLINE( 610)		this->add(this->text);
            	}
...
void FlxUIDropDownHeader_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_015f8e5857f13f23_614_destroy)
HXLINE( 615)		this->super::destroy();
HXLINE( 617)		this->background = ( ( ::flixel::FlxSprite)(::flixel::util::FlxDestroyUtil_obj::destroy(this->background)) );
HXLINE( 618)		this->text = ( ( ::flixel::addons::ui::FlxUIText)(::flixel::util::FlxDestroyUtil_obj::destroy(this->text)) );
HXLINE( 619)		this->button = ( ( ::flixel::addons::ui::FlxUISpriteButton)(::flixel::util::FlxDestroyUtil_obj::destroy(this->button)) );
            	}
